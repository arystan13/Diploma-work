                ...
                <div class="col-lg-8 p-r-0 title-margin-right">
                    <div class="page-header">
                        <div class="page-title">
                            <h1>Добавить группу</h1> <div class="card-content ">
                                ...
                                <div class="form-validation">
                                    <form class="form-valide" action="#" method="post">
                                      <div class="form-group row">
                                          ...
                                          <div class="col-lg-8">
                                              <input type="text" class="form-control" id="group" name="group" value="<?php echo @$data['group']; ?>" placeholder="Введите код группы">
                                          </div>
                                      </div>
                                        <div class="form-group row">
                                          ...
                                          <div class="col-lg-6">
                                              <select class="form-control" id="val-skill" name="spec_id">
                                                  <option value="<?php echo @$data['spec_id']; ?>"><?php if(isset($data['spec_id'])) {$saved_data = get_sql('select title from spec where id = '.$data['spec_id']);  echo @$saved_data[0]['title'];}  
                                                  else echo 'Выберите специальность'; ?></option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <select class="form-control" id="val-skill" name="degree_id">
                                                    <option value="<?php echo @$data['degree_id']; ?>"><?php if(isset($data['degree_id'])) {$saved_data = get_sql('select title from degree where id = '.$data['degree_id']);
                                                     echo @$saved_data[0]['title']; } 
                                                      else echo 'Выберите стпень группы'; ?></option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <select class="form-control" id="mode_id" name="mode_id">
                                                    <option value="<?php echo @$data['mode_id']; ?>"><?php if(isset($data['mode_id'])) {$saved_data = get_sql('select title from mode where id = '.$data['mode_id']); 
                                                     echo @$saved_data[0]['title'];} 
                                                      else echo 'Выберите форму обучения'; ?></option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <select class="form-control" id="val-skill" name="language_id">
                                                    <option value="<?php echo @$data['language_id']; ?>"><?php if(isset($data['language_id'])) {$saved_data = get_sql('select title from language where id = '.$data['language_id']);  
                                                    echo @$saved_data[0]['title'];} 
                                                     else echo 'Выберите язык обучения'; ?></option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" class="form-control" id="enter_year" name="enter_year" placeholder="Введи год начало" value="<?php echo @$data['enter_year']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <select class="form-control" id="val-skill" name="rup_id" required>
                                                    <option value="<?php echo @$data['rup_id']; ?>">
                                                    <?php if(isset($data['rup_id'])) {
                                                      $saved_data = get_sql('select * from rup where id = '.$data['rup_id']);
