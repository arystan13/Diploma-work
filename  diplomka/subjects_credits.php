<?php     error_reporting(0);
    ...
    $success = add_rups_credits($_POST);
        if($success == 'error') {
                        ...
                        <div class="page-header">
                            <div class="page-title">
                              <?php $rup_discipline = get_sql("select id from rupdiscipline order by id desc limit 1"); $rupa = $rup_discipline[0]["id"] ?>
                                <h1>Кредиты</h1> <div class="card-content ">
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Кредиты</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="form-validation">
                                        <form class="form-valide" action="subjects_credits.php?go=yes" method="post">
                                          ...
                                          <?php $discipline_title = get_sql("select discipline_name from discipline where id =".$discipline_title_id[0]["discipline_title_id"]);  ?>
                                            ...
                                            <hr><br>
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="val-skill">Семестр<span class="text-danger">*</span></label>
                                                <div class="col-lg-6">
                                                    <select class="form-control" id="val-skill" name="semester">
                                                        <option value="<?php echo @$data['semester']; ?>"><?php if(isset($data['semester'])) echo @$data['semester'];  else echo 'Выберите семестр'; ?></option>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="pps">Курсовая работа <span class="text-danger">*</span></label>
                                                <div class="col-lg-8">
                                                    <input type="checkbox" value="1" style="width: 20px; height: 40px;"  class="" id="pps" name="course_work" >
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="pps">Гос. экзамен <span class="text-danger">*</span></label>
                                                <div class="col-lg-8">
                                                    <input type="checkbox" value="1" style="width: 20px; height: 40px;"  class="" id="pps" name="gos" >
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="pps">Экзамен <span class="text-danger">*</span></label>
                                                <div class="col-lg-8">
                                                    <input type="checkbox" value="1" style="width: 20px; height: 40px;"  class="" id="pps" name="exam" >
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="val-skill">Лек<span class="text-danger">*</span></label>
                                                <div class="col-lg-6">
                                                    <select class="form-control" id="val-skill" name="lek_credits">
                                                      <option value="<?php echo @$data['lek_credits']; ?>"><?php if(isset($data['lek_credits'])) echo @$data['lek_credits'];  else echo 'Выберите кредит лекций'; ?></option>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="val-skill">Лаб<span class="text-danger">*</span></label>
                                                <div class="col-lg-6">
                                                    <select class="form-control" id="val-skill" name="lab_credits">
                                                        <option value="<?php echo @$data['lab_credits']; ?>"><?php if(isset($data['lab_credits'])) echo @$data['lab_credits'];  else echo 'Выберите кредит лаб'; ?></option>
                                                        <option value="0">0</option>
                                                        <option value="1">1</option>
                                                        <option value="2">2</option>
                                                        <option value="3">3</option>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="val-skill">Пр<span class="text-danger">*</span></label>
                                                <div class="col-lg-6">
                                                    <select class="form-control" id="val-skill" name="pr_credits">
                                                        <option value="<?php echo @$data['pr_credits']; ?>"><?php if(isset($data['pr_credits'])) echo @$data['pr_credits'];  else echo 'Выберите кредит пр'; ?></option>
                                                        <option value="0">0</option>
                                                        <option value="1">1</option>
                                                        <option value="2">2</option>
                                                        <option value="3">3</option>
