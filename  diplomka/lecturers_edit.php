...
$success = update_lecturer($_POST, $_GET['lecturer_id']);
    if($success == 'error') {
                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Проеподаватели</li>
                            </ol>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="form-valide" action="#" method="post">
                                        <?php $lecturer = get_sql("SELECT * FROM lecturers where id = ".$_GET['lecturer_id']); ?>
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="full_name">Ф.И.О <span class="text-danger">*</span></label>
                                            <div class="col-lg-8">
                                                <input type="text" value="<?= $lecturer[0]['full_name']; ?>" class="form-control" id="full_name" name="full_name" placeholder="Введите Ф.И.О студента">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <select class="form-control" id="val-skill" name="stepen_id">
                                                    <option value="<?php echo @$data['stepen_id']; ?>"><?php if(isset($data['stepen_id'])) {$saved_data = get_sql('select title from stepen where id = '.$data['stepen_id']);  echo $saved_data[0]["title"];} 
                                                     else echo 'Выберите степень'; ?></option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <select class="form-control" id="val-skill" name="position_id">
                                                    <option value="<?php echo @$data['position_id']; ?>"><?php if(isset($data['position_id'])) {$saved_data = get_sql('select title from position where id = '.$data['position_id']);  echo $saved_data[0]["title"];}  
                                                    else echo 'Выберите должность'; ?></option>
